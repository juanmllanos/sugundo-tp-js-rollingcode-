let pisosPiramide = parseInt(prompt('Ingrese el numero de escalones que quiera que tenga la piramide (Entre 1 y 50).'));
...
for (let escalones = 1; escalones <= pisosPiramide; escalones++) {
